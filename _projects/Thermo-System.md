...
I decided to analyze the kitchen refrigerator at my house. The images I have included shows the compressor, an integral part of a functioning fridge and a part that has been replaced since the old one broke a few years ago. I began with looking up the exact details of the compressor in order to determine some of its operating conditions. 
...
![Calculations]({{ "/assets/images/2210_math.jpg" | relative_url }}){: style="width: 550px;"}
...
![heat]({{ "/assets/images/2210_heat-ex.jpg" | relative_url }}){: style="width: 550px;"}
